<x-app-layout>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($jadwals as $index => $jadwal)
                                        @if ($jadwal->hari == 1)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">{{ $jadwal->mapel->user->name }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <button @click="openEdit = true; currentJadwal = {{ $jadwal }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center bg-red-200" colspan="4">Istirahat
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap bg-red-200">09:15 - 10:00</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center bg-red-200" colspan="4">
                                            Istirahat</td>
                                    </tr>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap bg-red-200">8</td>
    ...
    {{-- <div x-show="openCreate" class="fixed z-10 inset-0 flex items-center justify-center overflow-y-auto" @click.away="openCreate = false">
