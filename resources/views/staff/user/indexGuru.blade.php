                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    ...
                                    <div class="mt-2">
                                        <form method="POST" action="{{ route('staff.user.storeGuru') }}">
                                            @csrf
                                            <div class="mb-4">
                                                <label
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100"
                                        id="modal-title">Edit Guru</h3>
                                    <div class="mt-2">
                                        <form method="POST" :action="'/staff/user/updateGuru/' + currentUser.id">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-4">
                                                <label
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select
                                                    ...
                                                    x-model="currentUser.guru.jenis_kelamin">
                                                    <option value="">Pilih Jenis Kelamin</option>
                                                    <option value="1">Laki-laki</option>
                                                    <option value="2">Perempuan</option>
                                                </select>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select
                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline"
                                                    id="agama" name="agama" x-model="currentUser.guru.agama">
                                                    <option value="">Pilih Agama</option>
                                                    <option value="1">Islam</option>
                                                    <option value="2">Kristen</option>
                                                    <option value="3">Katolik</option>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input
                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline"
                                                    id="alamat" type="text" name="alamat"
                                                    x-model="currentUser.guru.alamat">
                                            </div>
                                            <div class="mb-4">
                                                <label
                                                    class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2 text-left"
                                                ...
                                                <input
                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline"
                                                    id="no_telp" type="text" name="no_telp"
                                                    x-model="currentUser.guru.no_telp">
                                            </div>
                                            <div class="flex items-center justify-end">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100"
                                        id="modal-title">Informasi Guru</h3>
                                    <div class="mt-5 grid grid-cols-2 gap-4 border p-4">
                                        <div class="mb-4 col-span-2">
                                            <img :src="currentUser.guru?.foto_url || '{{ asset('img/user.png') }}'"
                                        ...
                                        <div class="mb-4">
                                            <label
                                                class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2 text-left">Pekerjaan</label>
                                            <p class="text-gray-700 dark:text-gray-300 text-left"
                                                x-text="currentUser.role == 2 ? 'Guru' : 'Other'"></p>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <label
                                                ...
                                                Kelamin</label>
                                            <p class="text-gray-700 dark:text-gray-300 text-left"
                                                x-text="currentUser.guru?.jenis_kelamin == 1 ? 'Laki-laki' : currentUser.guru?.jenis_kelamin == 2 ? 'Perempuan' : 'User Belum Melengkapi Data'">
                                            </p>
                                        </div>
                                        <div class="mb-4">
                                            <label
                                            ...
                                            <p class="text-gray-700 dark:text-gray-300 text-left"
                                                x-text="currentUser.guru?.agama == 1 ? 'Islam' : currentUser.guru?.agama == 2 ? 'Kristen' : currentUser.guru?.agama == 3 ? 'Katolik' : currentUser.guru?.agama == 4 ? 'Hindu' : currentUser.guru?.agama == 5 ? 'Buddha' : currentUser.guru?.agama == 6 ? 'Konghucu' : 'User Belum Melengkapi Data'">
                                            </p>
                                        </div>
                                        <div class="mb-4">
                                            <label
                                                ...
                                                Telp</label>
                                            <p class="text-gray-700 dark:text-gray-300 text-left"
                                                x-text="currentUser.guru?.no_telp || 'User Belum Melengkapi Data'">
                                            </p>
                                        </div>
                                        <div class="mb-4 col-span-2">
                                            <label
                                            ...
                                            <p class="text-gray-700 dark:text-gray-300 text-left"
                                                x-text="currentUser.guru?.alamat || 'User Belum Melengkapi Data'"></p>
                                        </div>
                            ...
                            <div>
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <form :action="'{{ route('staff.user.destroyGuru', '') }}/' + currentUser.id"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div
