                                ...
                                @foreach ($prestasi as $prestasiItem)
                                    <tr
                                        ...
                                        <td class="flex items-center px-6 py-4">
                                            <form :action="'/staff/prestasi/' + {{ $prestasiItem->id }}" method="POST" class="inline flex space-x-3">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" name="status" value="1" class="text-yellow-600 dark:text-yellow-500 hover:underline bg-yellow-100 dark:bg-yellow-700 rounded-lg px-3 py-2" @if($prestasiItem->status == 1) disabled @endif>
                                                    <i class="fas fa-check "></i>
                                                </button>
                                                <button type="submit" name="status" value="2" class="text-red-600 dark:text-red-500 hover:underline bg-red-100 dark:bg-red-700 rounded-lg px-3 py-2" @if($prestasiItem->status == 1) disabled @endif>
